      ...
      <section className={styles.section} id="about">
        <div className={styles.aboutGrid}>
          ...
          <div className={styles.aboutBody}>
            <p>Nice2Meetya! is a premium social evening designed to make meeting strangers feel effortless. Games aren't the point — they're the permission structure. They lower the stakes, spark the first laugh, and create the conditions for real conversation.</p>
